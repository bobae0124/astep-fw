...
decoded_hits = []
file='20250523-144948.txt'
#file='20250520-175901_merge.txt'
#file='20250520-175800_merge.txt'
#file='20250407-160703.txt'
#file='20250404-162735.txt'
...
#file='20250327-182132.txt'
#file='20250327-182308.txt'
...
if decoded_hits:
    ...
    df_decoded_hits.to_csv('decoded_c2_'+file+'.tsv', sep='\t', index=False)
    print(f"Decoded data saved! : decoded_c2_{file}.tsv")
