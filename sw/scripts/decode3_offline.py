...
decoded_hits = []
file='20250523-145122.txt'
#file='20250520-180133_merge.txt'
#file='20250407-160334.txt'
...
if decoded_hits:
    ...
    df_decoded_hits.to_csv('decoded_c3_'+file+'.tsv', sep='\t', index=False)
    print(f"Decoded data saved! : decoded_c3_{file}.tsv")
