...
#    #works 1 plot
        ...
        print(f"plt.savefig(f{args.outdir}/Evt{ievt}_{len(pair)}hits_{args.beaminfo}_{args.name}__evtdisplay.png)")
        plt.savefig(f"{args.outdir}/Evt{ievt}_{len(pair)}hits_{args.beaminfo}_{args.name}__evtdisplay.png")
        plt.close()
