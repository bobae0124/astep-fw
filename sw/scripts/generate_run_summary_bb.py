...
#    print(f"{len(pixs)}, {npixel}% active")
    ...
    print(f"MatchingHit: {grouped_avg}")
    ...
    p1 = ax[0, 0].hist2d(x=dfpairc['col'], y=dfpairc['row'], bins=35, range=[[0,35],[0,35]], weights=dfpairc['hits'], cmap='YlOrRd', cmin=1.0, vmax=100)
