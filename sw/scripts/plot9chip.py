...
if not args.list:
    print("Please put a filelist; ls MatchingHitInfo*.csv > list.txt ; python3.12 plot9chip.py list")
filename = args.list
...
#filename='9chip_200th300inj'
#filename='9chip_200th400inj'
#filename='9chip_300th400inj'
...
fig.suptitle('9-Chip Hit Count Maps ('+filename+')', fontsize=18)
...
fig, axes = plt.subplots(2, 5, figsize=(25, 10))
fig.suptitle('9-Chip avg_tot_us (Averaged) Maps ('+filename+')', fontsize=18)
