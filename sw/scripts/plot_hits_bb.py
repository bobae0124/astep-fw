"""
06/2024 Bobae Kim updated hit map plots from offline csv file of beam measurements

python3.12 scripts/plot_hits_bb.py -d June2_TBpreparation/ -if June2_ftbf_may28FWSW_masked3col_t200_10m___20240602_144719_offline.csv 
> create HitMap_June2_ftbf_may28FWSW_masked3col_t200_10m___20240602_144719_offline.csv_proton120GeV_APSw06s01_0624TB.png 
"""
import argparse
import csv
...
#    # Draw Plot
    print("plt.savefig()")
    plt.savefig(f"HitMap_{args.inputfile}_{args.beaminfo}_{args.name}.png")
#    print("plt.show()")
#    plt.show()
...
if __name__ == "__main__":
    ...
    parser.add_argument('-n', '--name', default='APSw06s01_0624TB', required=False,
                    help='chip ID (APSw06s01) that can be used in name of output file')
...
#                    help = 'List run number(s) you would like to see')
    ...
    parser.add_argument('-b', '--beaminfo', default='LowEpion10GeV', required=False,
